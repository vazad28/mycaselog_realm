...
abstract class Result<S extends Object, F extends Object> {
  ...
  // Future<Result<S,F>> guard(Future<S> Function() future) async{
  //   return future().then((value) => Result.success(value)).catchError((f) {
  ...
  // ignore: public_member_api_docs
  //W guard<W>(Future<S> Function() future);
}
...
class Success<S extends Object, F extends Object> implements Result<S, F> {
  ...
  // ignore: public_member_api_docs
  static Future<Result<S, F>> guard<S extends Object, F extends Object>(
    Future<S> Function() future,
  ) async {
    try {
