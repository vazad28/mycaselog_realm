...
class MediaRepositoryImpl extends MediaRepository with LoggerMixin {
  ...
  Future<Result<List<HybridMediaModel>, RepositoryFailure>> getHybridMedias({
    ...
    try {
      final mediaModels =
          _databaseService.mediaCollection.getAll(location: location);
  ...
  @override
  Future<List<MediaModel>> getRemovedMediaList() async {
    return _databaseService.mediaCollection.getAll();
  }
