...
//       return _extractData(recognizedText);
...
//     final _blocks = recognizedText.blocks;
//     if (_blocks.isEmpty) return;

//     final firstLine = _blocks.first.lines.first.text;
//     final lastLine = _blocks.last.lines.last.text;

//     final name = _blocks[1].lines.first.text;

//     final patientModel = (widget.model as PatientModel)
//       ..mrn = lastLine.substring(0, lastLine.indexOf(' '))
//       ..yob = lastLine
//           .substring(lastLine.indexOf(' ') + 1, lastLine.indexOf('/') + 6)
//           .substring(2)
//       ..gender = lastLine.substring(lastLine.length - 1)
//       ..initials = name.initials
//       ..name = name;

//     // final patientModel = PatientModel(
//     //   mrn: lastLine.substring(0, lastLine.indexOf(' ')),
//     //   yob: lastLine.substring(lastLine.indexOf(' ') + 1, lastLine.indexOf('/') + 6).substring(2),
//     //   gender: lastLine.substring(lastLine.length - 1),
//     //   name: _blocks[1].lines.first.text,
//     // );
//   }
