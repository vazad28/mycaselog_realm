...
class _$OnSubmitFormImpl with DiagnosticableTreeMixin implements _OnSubmitForm {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AddTemplateFieldEvent.onSubmit()';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty('type', 'AddTemplateFieldEvent.onSubmit'));
  }
...
abstract class _OnSubmitForm implements AddTemplateFieldEvent {
