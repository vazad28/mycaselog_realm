...
part of '../../../add_case/provider/providers.dart';
...
final addCaseFormSubmitProvider =
    AutoDisposeNotifierProvider<AddCaseFormSubmit, StateOf<CaseModel>>.internal(
  AddCaseFormSubmit.new,
  name: r'addCaseFormSubmitProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$addCaseFormSubmitHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef _$AddCaseFormSubmit = AutoDisposeNotifier<StateOf<CaseModel>>;
